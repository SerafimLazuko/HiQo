...
namespace OAuth2.Infrastructure
{
    public static class RestClientExtensions
    {
        ...
        public static async Task<IRestResponse> ExecuteAndVerifyAsync(this IRestClient client, IRestRequest request, CancellationToken cancellationToken = default(CancellationToken))
        {
