...
namespace OAuth2.Client
{
    ...
    public abstract class OAuthClient : IClient
    {
        ...
        public async Task<string> GetLoginLinkUriAsync(string state = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (!state.IsEmpty())
            {
        ...
        /// </summary>
        /// <param name="cancellationToken">Optional cancellation token</param>
        private async Task QueryRequestTokenAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        private async Task QueryAccessTokenAsync(string verifier, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        private async Task<string> QueryUserInfoAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
