...
namespace OAuth2.Client
{
    ...
    public abstract class OAuth2Client : IClient
    {
        ...
        public virtual Task<string> GetLoginLinkUriAsync(string state = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public async Task<string> GetTokenAsync(NameValueCollection parameters, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public async Task<string> GetCurrentTokenAsync(string refreshToken = null, bool forceUpdate = false, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="parameters">Callback request payload (parameters).</param>
        /// <param name="cancellationToken">Optional cancellation token</param>
        private async Task QueryAccessTokenAsync(NameValueCollection parameters, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        protected virtual async Task<UserInfo> GetUserInfoAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <inheritdoc />
        public async Task<UserInfo> GetUserInfoAsync(NameValueCollection parameters, CancellationToken cancellationToken = default(CancellationToken))
        {
            GrantType = "authorization_code";
            CheckErrorAndSetState(parameters);
            await QueryAccessTokenAsync(parameters, cancellationToken).ConfigureAwait(false);
